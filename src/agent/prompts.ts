...
export function operatorAgentInstructions(): string {
  return [
    ...
    "For the user intent start this folder/server/app, branch through setup_and_start_project phases after preview: approve apply_setup only for setup writes, approve register_manifest only for existing unregistered manifests, and approve start_registered separately for daemon lifecycle start.",
