...
const POLICIES: ToolPolicy[] = [
  ...
  read("get_app_state"),
  read("get_app_group"),
  read("get_current_context"),
  read("get_agent_capabilities"),
  read("explain_app_problem", { sensitiveData: true }),
  read("get_diagnostics"),
  read("get_operation_status"),
  read("list_operations"),
  read("tail_logs", { sensitiveData: true }),
  read("search_logs", { sensitiveData: true }),
  read("project_list_files", { category: "setup" }),
  read("project_search_files", { category: "setup", sensitiveData: true }),
  read("project_read_file", { category: "setup", sensitiveData: true }),
  read("project_detect_start_commands", { category: "setup" }),
  read("project_inspect_package_scripts", { category: "setup", sensitiveData: true }),
  read("discover_project_roots", { category: "setup" }),
