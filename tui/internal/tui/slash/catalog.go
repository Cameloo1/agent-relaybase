...
var commandCatalog = []CommandDescriptor{
	...
	descriptor(KindRegister, "/register", "/register ", "setup", true, "Register an existing Relaybase manifest or project path.", []string{"/register <manifest-or-project-path>"}, []string{"/register ./apps/notes/relaybase.app.json"}, []string{"manifest", "project"}),
