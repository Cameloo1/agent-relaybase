...
func TestParseSlashCommands(t *testing.T) {
	tests := []struct {
		...
		{name: "manage", input: "/manage", kind: KindManage},
		{name: "list compatibility alias", input: "/list", kind: KindManage},
		{name: "usage", input: "/usage", kind: KindUsage},
		{name: "settings", input: "/settings", kind: KindSettings},
		{name: "agent settings", input: "/settings agent", kind: KindSettings, target: "agent"},
		{name: "agent security settings", input: "/settings agent security", kind: KindSettings, target: "agent security"},
		...
		{name: "daemon restart", input: "/daemon restart", kind: KindDaemonRestart},
...
func TestParseRequiredSlashCommandMatrix(t *testing.T) {
	tests := []struct {
		...
		{input: "/manage", kind: KindManage},
		{input: "/list", kind: KindManage},
...
func TestParseRejectsInvalidArgumentsAndFlags(t *testing.T) {
	tests := []struct {
		...
		{input: "/list now", want: "Use /manage."},
		{input: "/list --confirm", want: "Use /manage."},
		{input: "/confirm now", want: "Use /confirm."},
		{input: "/cancel now", want: "Use /cancel."},
		{input: "/settings nope", want: "Use /settings, /settings agent, or /settings agent security."},
		{input: "/daemon", want: "Use /daemon <status|repair|retry|restart>."},
		{input: "/daemon fix", want: "Use /daemon <status|repair|retry|restart>."},
